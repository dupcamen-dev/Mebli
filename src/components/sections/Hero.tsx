    ...
    <section className="relative w-full h-[100svh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1600px] mx-auto px-5 md:px-8 text-center">
        ...
        <h1 className="font-[family-name:var(--font-headline)] text-[30px] md:text-[56px] lg:text-[68px] font-medium leading-[1.05] tracking-[-0.02em] text-white max-w-5xl mx-auto mb-10 animate-fade-up" style={{ animationDelay: "0.1s" }}>
          Меблі, створені
          <br />
          <span className="font-[family-name:var(--font-script)] text-[34px] md:text-[60px] lg:text-[78px] font-normal" style={{ color: "#9c8a41" }}>вашим характером</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-up" style={{ animationDelay: "0.3s" }}>
          <a
            ...
            className="inline-flex items-center justify-center bg-white/15 text-white border border-white/30 px-12 py-5 text-[12px] md:text-[13px] font-bold uppercase tracking-[0.15em] font-[family-name:var(--font-body)] hover:bg-white/25 backdrop-blur-md transition-all duration-300 cursor-pointer rounded-lg shadow-[0_4px_20px_rgba(0,0,0,0.25)]"
          >
            Замовити проект
          </a>
          <a
